# 编译
```bash
protoc --plugin=protoc-gen-grpc-java=/home/ht061/gocode/bin/protoc-gen-grpc-java --grpc-java_out=src/main/java/ --java_out=src/main/java/ src/main/proto/user.proto
```
